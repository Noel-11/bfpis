<%@ Page Title="RefOccupation" Language="VB" AutoEventWireup="false" CodeFile="RefOccupationAdd.aspx.vb"
    Inherits="Secured_Reference_RefOccupationAdd" Theme="Skins"
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <h2 class="text-success">Occupation Details</h2>
                        </div>
                ...
                <div class="card-body" style="padding-bottom: 0px;">
                    <div class="container-fluid">
                        ...
                        <div class="row mb-1">
                             ...
                             <div class="col-lg-4">
                                <div class="input-group">
                                    <label class="input-group-text">Ref. Points</label>
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtRefPoints" TextMode="Number" min="0" max="100" step="any" ValidationGroup="DOC" />
                                </div>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtRefPoints" SetFocusOnError="true" Font-Italic="true" Font-Size="10pt" Display="Dynamic" Text="Reference Points is required" ValidationGroup="DOC" />
                            </div>
