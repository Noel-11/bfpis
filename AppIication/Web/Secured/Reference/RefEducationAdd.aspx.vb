...
Partial Class Secured_Reference_RefEducationAdd
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If thisMsgBox.getModalType = "SAVE" Then
            ...
            Response.Redirect("RefEducationAdd.aspx")
    ...
    Protected Sub btnHome_ServerClick(sender As Object, e As EventArgs) Handles btnHome.ServerClick
        Response.Redirect("RefEducation.aspx")
    End Sub

    Private Sub flllInfo()

        Dim _clsRefRecord As New clsRefEduc

        With _clsRefRecord
            .getRefEduc(hfTransId.Value)
            txtDescription.Text = .educDesc
    ...
    Private Sub saveRef()
        ...
        Dim _clsRefTrainings As New clsRefEduc

        With _clsRefTrainings
            .initialize()
            .transId = hfTransId.Value
            .educDesc = txtDescription.Text.Trim.ToUpper
