<%@ Page Title="RefEduc" Language="VB" AutoEventWireup="false" CodeFile="RefEducation.aspx.vb"
    Inherits="Secured_Reference_RefEducation" Theme="Skins"
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="text-success">Reference Education</h2>
                </div>
        ...
        <div class="card-body" style="padding-bottom: 0px;">
            <asp:UpdatePanel ID="updatePanel5" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="14px" CssClass="gridviewGreen table-bordered table-success table-striped table-hover" 
                        PageSize="15" EmptyDataText="NO RECORD FOUND" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="educ_desc" HeaderText="Description" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Left" />
                            <asp:BoundField DataField="ref_points" HeaderText="Ref Points" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" />
