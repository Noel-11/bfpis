Imports System.Data
Partial Class Secured_Reference_RefServices
    ...
    Protected Sub fillGv()
        ...
        Dim _clsRecord As New clsRefServices

        dt = _clsRecord.browseRefServices(txtSearch.Text.Trim)
    ...
    Protected Sub cmdGVUpdate(ByVal sender As Object, ByVal e As CommandEventArgs)
        Session("REF_SERVICE_ID") = e.CommandArgument.ToString
