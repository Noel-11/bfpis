<%@ Page Title="RefOccupation" Language="VB" AutoEventWireup="false" CodeFile="RefOccupation.aspx.vb"
    Inherits="Secured_Reference_RefOccupation" Theme="Skins"
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="text-success">Reference Occupation</h2>
                </div>
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="14px" CssClass="gridviewGreen table-bordered table-success table-striped table-hover" PageSize="15" EmptyDataText="NO RECORD FOUND"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="occupation_desc" HeaderText="Description" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Left" />
