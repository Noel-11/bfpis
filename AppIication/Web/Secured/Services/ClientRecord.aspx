<%@ Page Title="Client Record" Language="VB" AutoEventWireup="false" CodeFile="ClientRecord.aspx.vb"
    Inherits="Secured_Services_ClientRecord" Theme="Skins"
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="text-success">Client Record</h2>
                </div>

                <div class="col-lg-4">
                   <button runat="server" class="btn btn-success float-end" id="btnAdd"><i class="bi bi-plus-square"></i>&nbsp;Add New Client</button>
                </div>
                ...
                <ContentTemplate>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-8 mb-1">
                         ...
                         <div class="col-md-4 mb-1" runat="server" visible="false">
                            <div class="input-group">
                    ...
                    <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="14px" CssClass="gridviewGreen table-bordered table-success table-striped table-hover" PageSize="15" EmptyDataText="NO RECORD FOUND"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="cp_number" HeaderText="CP Number" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="barangay" HeaderText="Barangay" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" />
                            <asp:BoundField DataField="birth_date" HeaderText="Birth Date" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" />
