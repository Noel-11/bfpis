...
Public Class cPageInit_Secured_Client
    ...
    '    Dim _hfDelete As HiddenField = FindControl("hfDeleteButton")
    ...
    Public Function setCurrentPage(ByVal _intPageIndex As Integer, ByVal _dt As DataTable, Optional _isPage As Boolean = False) As String
