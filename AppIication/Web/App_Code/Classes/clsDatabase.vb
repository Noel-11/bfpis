...
Public Class clsDatabase
    ...
    Public Sub New()
        ...
        Else
            dbUtility.Initialize_DB_MYSQL_WEB("Server=localhost;Initial Catalog='db_bfpis';Persist Security Info=no;User Name='root';Password='ictlgucdo';default command timeout=360;Port=3306;Allow Zero Datetime=true;AllowUserVariables=True")
            'dbUtility.Initialize_DB_MYSQL_WEB("Server=172.16.1.102;Initial Catalog='db_pdis';Persist Security Info=no;User Name='db_pdis';Password='db_pdis';default command timeout=360;Port=3307;Allow Zero Datetime=true;AllowUserVariables=True")
